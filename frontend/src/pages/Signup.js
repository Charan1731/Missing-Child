      ...
      <div className="min-h-screen py-12 bg-stone-50">
        <div className="max-w-md mx-auto px-6">
          ...
          <div className="bg-white rounded-3xl border-2 border-stone-100 p-8 shadow-lg animate-slide-up">
            {GOOGLE_CLIENT_ID && (
              <div className="mb-6">
                <div className="flex justify-center" data-testid="google-signup-button">
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-white text-stone-500 font-medium">Or sign up with email</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="mt-6 text-center">
              <p className="text-stone-600">
                ...
                <Link to="/login" className="text-amber-600 font-semibold hover:text-amber-700" data-testid="login-link">
                  Sign in
                </Link>
              </p>
            </div>
